...
import com.delta.irfan.alpha.dataaccess.AgentBusinessLogic;
import com.delta.irfan.alpha.dataaccess.AgentBusinessLogic.DetailAgent;
import com.delta.irfan.alpha.dataaccess.OrderBusinessLogic;
import com.delta.irfan.alpha.dataaccess.OrderBusinessLogic.*;
...
//        };
    ...
    public boolean onContextItemSelected(MenuItem item){
        ...
        if(item.getTitle()=="Order Sekarang"){
            ...
            Toast.makeText(getApplicationContext(),"Order sukses terkirim...",Toast.LENGTH_LONG).show();
        }
