...
import com.delta.irfan.dataaccess.CustomerBusinessLogic;
import com.delta.irfan.location.GPSTracker;
...
//            etPhone.setText(feedEntry.getPhone());
    ...
    private void openListAgent(){
        ...
        Intent customersIntent  = new Intent(MainActivity.this, ListAgent.class);
